...
* Download the file `2024-10-24_library-data.sqlite` from [this
  link][materials].

> **NOTE**:  
> You must have a UC Davis account to access the data; contact Nick Ulle
> (<naulle@ucdavis.edu>) if you have difficulty accessing the data.
...
[materials]: https://drive.google.com/file/d/1PpVm3WWojIEYrEQxxLmrxiaX1puUpaSS/view?usp=drive_link
