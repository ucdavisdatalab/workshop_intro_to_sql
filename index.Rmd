...
relational databases. This workshop covers basic SQL commands to view, filter,
...
database, but most of the commands are applicable to other database systems as
