...
We'll be working with the Library Checkouts Database, a fictious dataset about users checking out books from the library. 

<!--For more detailed information on how it was put together, please refer to the GitHub repository [here](). -->
...
<!-- ![Library Checkouts ERD](images/library-checkouts-erd.png) -->
