...
> **NOTE**:
> 
> - Commands in brackets "[ ]" is optional
...
A RDBMS is a software that interacts with databases, users, and other applications. For the workshop we’ll be working with SQLite. It's a lightweight and portable RDBMS that runs on Windows, MacOS, and Linux with no complex setup. 
...
> **NOTE**:  
> Other popular RDBMS's include MySQL, Postgres, and Microsoft SQL Server, but requre setting up a server.
